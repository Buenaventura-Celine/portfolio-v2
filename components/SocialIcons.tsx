      ...
      <div className="flex gap-[6px]">
        {items.map((item) => (
          <a
            ...
            className="flex items-center justify-center w-9 h-9 text-muted rounded-full translate-y-0 transition-all duration-[180ms] ease-[cubic-bezier(0.25,0.1,0.25,1)] hover:text-accent hover:bg-sky hover:-translate-y-[2px]"
          >
            <svg
              viewBox="0 0 24 24"
              width="18"
